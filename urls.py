...
urlpatterns = [
    ...
    path('headmaster/print_report/<int:class_id>/', views.print_class_report, name='print_class_report'),
    path('headmaster/settings/', views.headmaster_settings, name='headmaster_settings'),
    path('headmaster/change_password/<int:teacher_id>/', views.change_teacher_password, name='change_teacher_password'),
    path('headmaster/overall_report/<int:student_id>/', views.overall_report, name='overall_report'),
